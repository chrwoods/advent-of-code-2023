...
print(get_point(22, 2090000000))
print(get_point(24, 0))
...
for i in range(check):
    ...
    for j in range(check):
        ...
        for k in range(check):
            ...
            if x == y:
                pv = get_p(p1, p2)
                for blump in range(0, 5):
                    print(get_future(p1, pv, i * blump))
                    print(get_future(p2, pv, j * blump))
                    print(get_future(p3, pv, k * blump))
